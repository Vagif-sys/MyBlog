                   ...
                   <div class="form-body mt-4">
                    <div class="row">
                       ...
                       <div class="border border-3 p-4 rounded"> 
                          <div class="mb-3">
                            <label for="inputProductTitle" class="form-label">Related Posts</label>
                            <div class="card">
                            <div class="card-body">
                          ...
                          <div class="mb-3">
                            ...
                            <textarea class="form-control" name="the_comment" id="post_comment" rows="8">{{ old('the_comment') }}</textarea>
                            @error('the_comment')
                                <p class='text-danger'>{{ $message }}</p>
                            @enderror  
                          </div>
