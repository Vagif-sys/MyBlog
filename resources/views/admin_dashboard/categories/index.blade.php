							...
							<table class="table mb-0">
								...
								<tbody>
									...
									<tr>
                                        ...
                                        <td>
                                            <a class='bt btn-primary btn-sm' href="{{ route('admin.categories.show',$category) }}">Related Posts</a>
                                        </td>
										...
										<td>
											<div class="d-flex order-actions">
												...
												<a href="#" onclick="event.preventDefault(); document.getElementById('delete_form_{{ $category->id }}').submit();" onClick="return confirm('Are you sure?');" class="ms-3"><i class='bx bxs-trash'></i></a>
