							...
							<table class="table mb-0">
								...
								<tbody>
									...
									<tr>
										...
										<td>
                                            <img width='100px' src="{{ asset( $user->image ? 'uploads/'.$user->image->path : 'uplaods/placeholders/user.png') }}">
                                        </td>
                                        <td>{{ $user->name  }}</td>
                                        <td>{{ $user->email  }}</td>
										...
										<td>
											<div class="d-flex order-actions">
												...
												<a href="#" onclick="event.preventDefault(); document.getElementById('delete_form_{{ $user->id }}').submit();" onclick="return confirm('Are you sure?');" class="ms-3"><i class='bx bxs-trash'></i></a>
