        ...
        <div class="page-content">
            ...
            <div class="card">
              <div class="card-body p-4">
                   ...
                   <div class="form-body mt-4">
                    <div class="row">
                       ...
                       <div class="border border-3 p-4 rounded"> 
                          <div class="mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type='text' class="form-control" name="name" id="name" rows="8" value="{{ old('name',$user->name) }}">
                                    @error('name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type='email' class="form-control" name="email" id="email" rows="8" value="{{ old('email',$user->email) }}">
                                    @error('email')
                                        <p class='text-danger'>{{ $message }}</p>
                                    @enderror  
                                </div>
                                ...
                                <div class='row'>
                                    <div class='col-md-8'>
                                        ...
                                        <div class='row'>
                                        <div class='col-sm-4'>
                                            <img src="{{  asset($user->image ? 'uploads/'.$user->image->path : 'uploads/placeholders/user.png')}}">
                                        </div>
                                     </div>
                                   </div>  
                                </div>
                          ...
                          <a href="#" onclick="event.preventDefault(); document.getElementById('delete_user_{{ $user->id }}').submit();" onclick="return confirm('Are you sure?');" class="ms-3">
                ...
                <form if='delete_user_{{ $user->id }}'action="{{ route('admin.users.destroy') }}" method='POST'>@csrf $method('PATCH')</form>
                </div>
              </div>
          </div>
