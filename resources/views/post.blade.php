					...
					<div class="row row-pb-lg">
						<div class="col-md-12 animate-box">
							<div class="classes class-single">
								<div class="classes-img" style="background-image: url({{ asset($post->image ? 'blog_template/'.$post->image->path : 'uploads/placeholders/thumbnail.png') }});">
								</div>
					...
					<div class="row row-pb-lg animate-box">
						<div class="col-md-12">
							...
							<div id="comment_{{ $comment->id }}" class="review">
								<div class="user-img" 
								style="background-image: url({{ $comment->user->image 
									?asset('storage/'.$comment->user->image->path.'') : '' }});"></div>
									<div class="desc">
										<h4>
